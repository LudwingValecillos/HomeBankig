...
public class CorsConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList(new String[]{"http://localhost:8080", "http://localhost:5173", "https://homebankig.onrender.com", "https://homebankig-frontend.onrender.com"}));
